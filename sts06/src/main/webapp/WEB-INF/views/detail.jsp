...
<body>
	...
	<form action="update" method="post">
		...
		<div>
			...
			<input type="text" class="edit" value="${bean.name }" name="name" id="name" />
		</div>
		<div>
			<label for="nalja">nalja</label>
			<input type="text" value="${bean.nalja }" id="nalja" />
		</div>
		<div>
			<label for="pay">pay</label>
			<input type="text" class="edit" value="${bean.pay }" name="pay" id="pay" />
		</div>
